...
def plot_distribution(weights_clean, weights_noise, corruptionProb, corruptionType, i):
    ...
    default_bins = 60
    bins = int(default_bins * (max(np.concatenate((weights_noise, weights_clean))) - min(np.concatenate((weights_noise, weights_clean)))))
    print(bins)
    ...
    plot_path = results_path + 'plots/weights_distribution_loss_sequence_corruptionProb{}_corruptionType{}_seed{}_epoch{}.png'.format(
