...
loss_history_path = results_path + 'loss_sequence/losses_corruptionProb{}_corruptionType{}_average3.npy'.format(args.corruption_prob, args.corruption_type)
model_path = results_path + 'models/model_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
vnet_path = results_path + 'models/vnet_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
weight_path = results_path + 'models/weight_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.npy'.format(args.corruption_prob, args.corruption_type, args.seed)
txt = results_path +  'results/result_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.txt'.format(args.corruption_prob, args.corruption_type, args.seed)
...
model_path_mid = results_path + 'models/model_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}_mid.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
vnet_path_mid = results_path + 'models/vnet_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}_mid.pth'.format(args.corruption_prob, args.corruption_type, args.seed)

model_path_last = results_path + 'models/model_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}_last.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
vnet_path_last = results_path + 'models/vnet_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}_last.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
...
def train(train_loader,train_meta_loader,model, vnet,optimizer_model,optimizer_vnet,epoch, loss_history):
    print('\nEpoch: %d' % epoch)
    ...
    for batch_idx, (inputs, targets, index) in enumerate(train_loader):
        ...
        # for params in vnet.params():
        #     print('meta model params', params)
        #     break
        model.train()
        inputs, targets = inputs.to(device), targets.to(device)
        ...
        del grads
        # for params in vnet.params():
        #     print('meta model params after update:', params)
        #     break
        try:
        ...
        #     print('model params after update:', params)
        #     break
        outputs = model(inputs)
...
loss_history = loss_history.to(device=device, dtype=torch.float)
...
def main():
    ...
    # cost_v_random = torch.randn((len(train_loader.dataset), 1))
    # cost_v_random = cost_v_random.to(device=device)
    weight_recorder = np.zeros((len(train_loader.dataset), args.epochs))

    # cost_v_random = to_var(cost_v_random)
    for epoch in range(args.epochs):
        ...
        indexes, weights = train(train_loader,train_meta_loader,model, vnet,optimizer_model,optimizer_vnet,epoch, loss_history)
    ...
    # torch.save(vnet.state_dict(), './model_weights/vnet_state_corruptionProb{}_corruptionType{}_lossSeq.pth'.format(args.corruption_prob, args.corruption_type))
    # torch.save(model.state_dict(), './model_weights/model_state_corruptionProb{}_corruptionType{}_lossSeq.pth'.format(args.corruption_prob, args.corruption_type))
