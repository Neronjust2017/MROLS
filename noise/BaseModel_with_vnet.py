...
model_path = results_path + 'models/model_state_with_vnet_no_meta_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
vnet_path = results_path + 'models/vnet_state_with_vnet_no_meta_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
txt = results_path +  'results/result_with_vnet_no_meta_corruptionProb{}_corruptionType{}_seed{}.txt'.format(args.corruption_prob, args.corruption_type, args.seed)
...
def train(train_loader, model, vnet,optimizer_model,optimizer_vnet,epoch):
    print('\nEpoch: %d' % epoch)
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        indexes, losses, entropy, losses_intensified = train(train_loader, model, vnet,optimizer_model,optimizer_vnet,epoch)
