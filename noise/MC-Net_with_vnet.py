...
model_path = results_path + 'models/model_state_with_vnet_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
txt = results_path +  'results/result_with_vnet_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.txt'.format(args.corruption_prob, args.corruption_type, args.seed)
...
# vnet trained with loss sequence
loss_history_path = results_path + 'loss_sequence/losses_corruptionProb{}_corruptionType{}_average3.npy'.format(args.corruption_prob, args.corruption_type, args.seed)
vnet_path_ls = results_path + 'models/vnet_state_loss_sequence_corruptionProb{}_corruptionType{}_seed{}.pth'.format(args.corruption_prob, args.corruption_type, args.seed)
...
def train(train_loader, model, vnet,optimizer_model,epoch, loss_history):
    print('\nEpoch: %d' % epoch)
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        indexes, losses, train_loss, meta_loss = train(train_loader, model, vnet,optimizer_model,epoch,loss_history)
